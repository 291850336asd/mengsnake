...
import static com.snake.game.snake.model.SnakeDirection.*;
...
public class SnakeEntity {
    ...
    public SnakeEntity(NormalGameEngine engine, String accountId, int startPoint, int initBodyCount, SnakeDirection defaultDirection, Channel channel) {
        this.engine = engine;
    ...
    public void setDirection(SnakeDirection direction){
        for(SnakeDirection oldDirection: new SnakeDirection[]{this.direction, lastChangeDirection}){
            ...
            if (oldDirection == LEFT && direction == SnakeDirection.RIGHT){
                return;
            }
    ...
    public void addLineToHead(){
        ...
        if (bodys.isEmpty()) {
            ...
            if(lastChangeDirection != direction){
                ...
                if(lastChangeDirection == LEFT || lastChangeDirection == SnakeDirection.RIGHT){
                    //左右
                    turnCondition = bodys.get(0)[0] == bodys.get(bodyNodeSize * bodyNodeSize - bodyNodeSize)[0];
                } else if(lastChangeDirection == DOWN || lastChangeDirection == UP){
                    //上下
